...
```sh
python .Codex/skills/skogai-architecture/scripts/records.py new feature "Continue a session"
python .Codex/skills/skogai-architecture/scripts/records.py new decision "Provider-owned sessions"
python .Codex/skills/skogai-architecture/scripts/records.py check docs/features/continue-a-session.md
```
